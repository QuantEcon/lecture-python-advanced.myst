...
However, we can model time series with persistent growth using methods that enable statistical learning based on a law of large numbers for an asymptotically stationary and ergodic process.
